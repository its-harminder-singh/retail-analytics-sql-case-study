...
This project demonstrates an end-to-end retail analytics workflow using MySQL. It covers data cleaning, exploratory data analysis (EDA), customer segmentation, sales trend analysis, and business insights generated from retail sales data.
